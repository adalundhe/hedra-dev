        ...
        <div className="w-screen text-center font-rany flex flex-col items-center bg-[#eeeeee] " ref={leaveRef.ref}>
            ...
            <div className="w-screen grid-rows-2">
                ...
                <div className="flex justify-center">
                    <div className="w-[90vh] mx-[4vw] code-block-large lg:text-[1.5vmin] sm:text-[1.75vmin] text-[2.2vmin] py-2 leading-[1.5vmin] tracking-wider font-lighter font-informe text-left shadow-2xl bg-[#2e3131] h-[100%]">
                        <CodeBlock 
                            text={codeExample}
                            language={'python'}
