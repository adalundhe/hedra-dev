...
1
    ...
    return (
        <>
            <DocsNavMobile />
           <div 
                className={`h-full overscroll-none lg:mt-10 grid grid-cols-[auto] lg:grid-cols-[24rem_auto] 2xl:grid-cols-[24rem_auto_24rem] overflow-x-hidden ${isOpen ?  'invisible' : ''} ${docsNavOpen ? 'invisible' : ''}`}
                ref={ref}
                onWheel={(() => {
